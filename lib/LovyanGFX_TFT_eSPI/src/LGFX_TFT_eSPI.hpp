...
class MyLGFX : public lgfx::LGFX_SPI<MyLGFX_Config>
{
  struct Panel_default : public lgfx::Panel_ST7789
  {
    Panel_default(void) {
      spi_3wire = false;
      spi_cs   = -1;
...
public:
  ...
  MyLGFX(void) : lgfx::LGFX_SPI<MyLGFX_Config>()
  {
  ...
  void initPanel(void) override
  {
    ...
    lgfx::LGFX_SPI<MyLGFX_Config>::initPanel();
  }

};

typedef MyLGFX TFT_eSPI;
